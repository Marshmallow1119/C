...
public interface HelloListener extends ParseTreeListener {
	/**
	 * Enter a parse tree produced by {@link HelloParser#end}.
	 * @param ctx the parse tree
	 */
	void enterEnd(HelloParser.EndContext ctx);
	/**
	 * Exit a parse tree produced by {@link HelloParser#end}.
	 * @param ctx the parse tree
	 */
	void exitEnd(HelloParser.EndContext ctx);
	/**
