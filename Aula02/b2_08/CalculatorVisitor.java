...
public interface CalculatorVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitStatAssignment(CalculatorParser.StatAssignmentContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code UnitaryPlus}
	 * labeled alternative in {@link CalculatorParser#expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitUnitaryPlus(CalculatorParser.UnitaryPlusContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code UnitaryMinus}
	 * labeled alternative in {@link CalculatorParser#expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitUnitaryMinus(CalculatorParser.UnitaryMinusContext ctx);
	/**
